...
def main():
    ...
    if not kb_success:
        ...
        print("1. OpenAI Issues:")
        print("   - Check your OPENAI_API_KEY in .env file")
        print("   - Verify your OpenAI account has available credits")
        print("   - Check billing at https://platform.openai.com/account/billing")
        print("2. Pinecone Issues:")
        print("   - Check your PINECONE_API_KEY in .env file") 
        print("   - Ensure you have a valid Pinecone free tier account")
        print("3. Network Issues:")
        print("   - Check your internet connection")
        print("   - Verify firewall isn't blocking API requests")
